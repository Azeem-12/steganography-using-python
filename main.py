...
#second frame
f2=Frame(root,bd=3,bg="violet",width=340,height=280,relief=GROOVE)
f2.place(x=350,y=80)

text1=Text(f2,font="Robote 20",bg="violet",fg="black",relief=GROOVE,wrap=WORD)
...
Label(f3,text="Pictures, Image, Photo file",bg="#2d4155",fg="black").place(x=20,y=5)
...
Label(f4,text="Pictures, Image, Photo file",bg="#2d4155",fg="black").place(x=20,y=5)
